<script lang="ts">
	...
	// room — a song's title on the radio (see TownRadio), which is the first row of the plate
	// laid on the map's bottom edge, and the title is whatever the record is called. An
