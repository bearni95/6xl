<script lang="ts">
	...
	// room — a song's title on the radio (see MusicBanner), which is the middle of the band
	// across the top of the page, and the title is whatever the record is called. An
