<script lang="ts">
	...
	// room — a song's title on the radio (see MusicBanner), which is a row of its own along the
	// map's bottom edge, and the title is whatever the record is called. An
