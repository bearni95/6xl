<script lang="ts">
	...
	// here now: the radio is a row of its own on the plate at the map's bottom edge (see
	// TownRadio), so every crumb this game draws letters the show it flies. The slot stays
